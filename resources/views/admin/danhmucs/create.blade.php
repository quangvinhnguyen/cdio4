...
{!! Form::open(array('route' => config('quickadmin.route').'.danhmucs.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('ma_cdm', old('ma_cdm'), array('class'=>'form-control')) !!}
